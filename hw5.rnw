...
\textbf{Figure 4} shows... Note with the big dots it's hard to see individual locations. I'd use a continuous color scale but that has it's own problems.
